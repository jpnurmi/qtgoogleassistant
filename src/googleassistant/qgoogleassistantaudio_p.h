...
#ifndef QGOOGLEASSISTANTAUDIO_P_H
#define QGOOGLEASSISTANTAUDIO_P_H
...
class QGoogleAssistantAudioPrivate
{
public:
    static QIODevice *createBuffer(QObject *parent = nullptr);
};

QT_END_NAMESPACE

#endif // QGOOGLEASSISTANTAUDIO_P_H
